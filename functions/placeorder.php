<?php
    ...
    if(isset($_SESSION['auth']))
    {
        if(isset($_POST['placeOrderBtn']))
        {
            ...
            $tracking_no = "id".rand(1111,9999).substr($phone, 2);
            ...
            VALUE ('$tracking_no', '$userId', '$name', '$email', '$phone', '$address', '$pincode', '$totalPrice', '$payment_mode', '$payment_id')";
            ...
            if($insert_query_run)
            {
                ...
                foreach($query_run as $citem)
                {
                    ...
                    VALUE ('$order_id', '$prod_id', '$prod_qty', '$price')";
                    $insert_query_run = mysqli_query($con, $insert_item_query);
                ...
                $deleteCartQuery = "DELETE FROM carts WHERE user_id='$user_id' LIMIT 1";
